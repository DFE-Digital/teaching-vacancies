...
ARG PROD_PACKAGES
ENV DEV_PACKAGES="gcc=10.3.1_git20211027-r0 libc-dev=0.7.2-r3 make=4.3-r0 yarn=1.22.17-r0 postgresql13-dev=13.5-r0 build-base=0.5-r2 libxml2-dev=2.9.12-r2 libxslt-dev=1.1.34-r1 git"
