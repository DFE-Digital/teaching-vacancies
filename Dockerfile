 ...
 # Alpine v3.23
 # TODO: Regularly check in the alpine ruby "3.4.8-alpine3.23" images for its latest upgraded packages so we can remove
...
ARG PROD_PACKAGES="lcms=2.19-r0 imagemagick=7.1.2.19-r0 zlib=1.3.2-r0 expat=2.7.5-r0 libpng libjpeg libxml2 libxslt libpq tzdata shared-mime-info postgresql18 vips-poppler vips-magick proj-dev"
