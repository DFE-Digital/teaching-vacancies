...
ARG PROD_PACKAGES="imagemagick=7.1.2.17-r0 zlib=1.3.2-r0 expat=2.7.5-r0 libpng libjpeg libxml2 libxslt libpq tzdata shared-mime-info postgresql18 vips-poppler vips-magick proj-dev"
