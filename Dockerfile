ARG PROD_PACKAGES="libxml2=2.9.12-r2 libxslt=1.1.34-r1 libpq=14.1-r4 tzdata=2021e-r0 shared-mime-info=2.1-r0 util-linux=2.37.2-r1 busybox=1.34.1-r3"
...
ARG PROD_PACKAGES
ENV DEV_PACKAGES="gcc=10.3.1_git20211027-r0 libc-dev=0.7.2-r3 make=4.3-r0 yarn=1.22.17-r0 postgresql14-dev=14.1-r4 build-base=0.5-r2 libxml2-dev=2.9.12-r2 libxslt-dev=1.1.34-r1 git"
