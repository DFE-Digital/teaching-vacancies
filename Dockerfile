...
ARG PROD_PACKAGES="imagemagick libpng=1.6.55-r0 openssl expat=2.7.4-r0 libjpeg libxml2 libxslt libpq tzdata shared-mime-info postgresql18=18.2-r0 vips-poppler vips-magick proj-dev"
