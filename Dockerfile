...
ARG PROD_PACKAGES="imagemagick libpng openssl expat=2.7.4-r0 libjpeg libxml2 libxslt libpq tzdata shared-mime-info postgresql=18.2-r0 vips-poppler vips-magick proj-dev"
...
ARG PROD_PACKAGES
ENV DEV_PACKAGES="gcc libc-dev make yaml-dev yarn postgresql-dev=18.2-r0 build-base git"
