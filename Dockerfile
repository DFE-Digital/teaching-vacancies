 ...
 # Alpine v3.23
 # TODO: Regularly check in the alpine ruby "4.0.3-alpine3.23" images for its latest upgraded packages so we can remove
...
ARG PROD_PACKAGES="imagemagick=7.1.2.19-r0 zlib=1.3.2-r0 expat=2.7.5-r0 libpng libjpeg libxml2 libxslt libpq tzdata shared-mime-info postgresql18 vips-poppler vips-magick proj-dev"

FROM ruby:4.0.3-alpine3.23 AS builder
...
FROM ruby:4.0.3-alpine3.23 AS production
