...
ARG PROD_PACKAGES="imagemagick=7.1.2.3-r0 libpng libjpeg libxml2 libxslt libpq tzdata shared-mime-info postgresql15 libpq=17.6-r0 openssl=3.5.4-r0 libcrypto3=3.5.4-r0 pcre2=10.46-r0"
