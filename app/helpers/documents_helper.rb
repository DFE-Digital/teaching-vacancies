module DocumentsHelper
  ...
  def remove_application_form_link
    govuk_link_to organisation_job_application_forms_path(vacancy.id, back_to_review: params[:back_to_review], back_to_show: params[:back_to_show]), method: :delete do
