module DocumentsHelper
  def remove_document_link(document, vacancy)
    govuk_link_to organisation_job_documents_path(id: document.id, job_id: vacancy.id, back_to_review: params[:back_to_review], back_to_show: params[:back_to_show]), method: :delete do
