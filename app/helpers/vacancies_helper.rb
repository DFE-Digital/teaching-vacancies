module VacanciesHelper
  ...
  def vacancy_review_section_tag(vacancy, steps)
    ...
    return govuk_tag( text: t("shared.status_tags.action_required"), colour: "red" ) if vacancy_forms_contain_errors?(form_classes)

    govuk_tag( text: t("shared.status_tags.complete") )
  end

  def vacancy_forms_contain_errors?(form_classes)
