class Publishers::JobListing::CopyVacancyForm < Publishers::JobListing::ImportantDatesForm
  ...
  def job_title_has_no_tags?
    job_title_with_not_escaped_characters = job_title.delete("&")
    return if job_title_with_not_escaped_characters == sanitize(job_title_with_not_escaped_characters, tags: [])
