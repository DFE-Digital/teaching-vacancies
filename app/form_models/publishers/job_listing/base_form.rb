# duplicate of BaseForm - spike do not copy
class Publishers::JobListing::BaseForm < DfE::Wizard::Step
  ...
  class << self
    # revert this change from Dfe::Wizard::Step as it messes up all our translations
    def model_name
