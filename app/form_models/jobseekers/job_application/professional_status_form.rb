class Jobseekers::JobApplication::ProfessionalStatusForm
  ...
  attr_accessor :qualified_teacher_status, :qualified_teacher_status_year, :no_qualified_teacher_status_details,
  ...
  validates :no_qualified_teacher_status_details, presence: true, if: -> { qualified_teacher_status == "no" }
