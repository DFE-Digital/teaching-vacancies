class Vacancy < ApplicationRecord
  ...
  PRIMARY_JOB_ROLES =  { teacher: 0, leadership: 1, education_support: 4, sendco: 5 }
  ADDITIONAL_JOB_ROLES = { sen_specialist: 2, nqt_suitable: 3 }
  ...
  def primary_job_role
    ...
    # about the first
    job_roles.select { |role| role.in?(self.class.primary_job_role_options) }.first
  end
