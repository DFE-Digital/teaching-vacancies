class GeneralFeedback < ApplicationRecord
  ...
  validates :visit_purpose, presence: { message: I18n.t('general_feedback.visit_purpose_errors.blank') }

  validates :visit_purpose_comment, length: { maximum: 1200, \
    message: I18n.t('general_feedback.visit_purpose_errors.over_max_length') }, if: :visit_purpose_comment?
