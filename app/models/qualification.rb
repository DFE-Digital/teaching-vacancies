class Qualification < ApplicationRecord
  ...
  def finished_studying_option_with_details
    [
      I18n.t("helpers.label.jobseekers_job_application_details_qualifications_shared_labels.finished_studying_options.#{finished_studying}"),
      sanitize(finished_studying_details.presence),
