module Publishers::Wizardable
  ...
  def job_role_params(params)
    params.require(:publishers_job_listing_job_role_form).permit(:main_job_role).merge(completed_steps:)
  end
  ...
  def schools_params(params)
    ...
    readable_job_location = readable_job_location(job_location, school_name:, schools_count:)
    attributes_to_merge = {
      completed_steps:,
      job_location:,
  ...
  def education_phases_params(params)
    ...
    if params["publishers_job_listing_education_phases_form"]
      params.require(:publishers_job_listing_education_phases_form).permit(:phase).merge(completed_steps:)
    else
      {}
    end
  end
  ...
  def applying_for_the_job_params(params)
    if params[:publishers_job_listing_applying_for_the_job_form]
      ...
      {}
    end.merge(completed_steps:, current_organisation:)
  end
