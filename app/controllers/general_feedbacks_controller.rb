class GeneralFeedbacksController < ApplicationController
  ...
  def feedback_attributes
    general_feedback_form_params.reject { |param| param == "report_a_problem" }.merge(feedback_type: "general", jobseeker_id: current_jobseeker&.id, publisher_id: current_publisher&.id)
  end
end
