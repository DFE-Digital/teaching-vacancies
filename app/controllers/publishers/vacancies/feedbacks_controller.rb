class Publishers::Vacancies::FeedbacksController < Publishers::Vacancies::BaseController
  ...
  def feedback_attributes
    feedback_form_params.reject { |param| param == "report_a_problem" }.merge(feedback_type: "vacancy_publisher", publisher_id: current_publisher&.id, vacancy_id: @vacancy.id)
  end
end
