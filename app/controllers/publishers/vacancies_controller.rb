class Publishers::VacanciesController < Publishers::Vacancies::BaseController
  ...
  helper_method :applying_for_the_job_fields, :documents_fields, :important_dates_fields, :job_details_fields, :job_location_fields, :job_roles_fields, :job_summary_fields, :pay_package_fields, :schools_fields
  ...
  def redirect_to_incomplete_step
    return redirect_to organisation_job_build_path(vacancy.id, :job_roles) unless step_valid?(:job_roles)
