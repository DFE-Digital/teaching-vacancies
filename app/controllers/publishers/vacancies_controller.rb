class Publishers::VacanciesController < Publishers::Vacancies::BaseController
  ...
  def show_application_reminder_page?
    ...
    current_publisher.viewed_new_features_page_at.present? &&
      vacancies_published_after_viewing_new_features_page&.any? &&
      vacancies_published_after_viewing_new_features_page&.any?(&:enable_job_applications?).blank?
  end
