...
describe('panel', () => {
  ...
  <button data-action="click->panel#toggle" class="${TOGGLE_ELEMENT_CLASS}" data-panel-id="test-panel" data-panel-target="toggle">panel toggle</button>
  <div class="${CONTENT_ELEMENT_CLASS}" tabindex="-1" id="test-panel" data-panel-target="content">
