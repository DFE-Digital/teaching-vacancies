...
<div class="${ACCORDION_SECTION_CLASS_SELECTOR}"><div class="govuk-accordion__section-header"><h3 class="heading"><button class="govuk-accordion__section-button"></button></h3></div></div>
      ...
      init(ACCORDION_SECTION_CLASS_SELECTOR, REMOVE_FILTER_CLASS_SELECTOR, 'clear-filters-component-button', 'close-all-groups', 'mobile-filters-component-button', 'govuk-accordion__section-header');
