class SearchableCollectionComponent < GovukComponent::Base
  attr_accessor :form, :input_type, :attribute_name, :collection, :value_method, :text_method, :hint_method, :threshold, :small, :label_text, :form_group, :small, :options, :scrollable
