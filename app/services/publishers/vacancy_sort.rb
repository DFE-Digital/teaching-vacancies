class Publishers::VacancySort < RecordSort
  ...
  def job_title_option
    SortOption.new("job_title_option", "asc", I18n.t("jobs.sort_by.job_title_option.ascending"))
  end
  ...
  def readable_job_location_option
    SortOption.new("readable_job_location_option", "asc", I18n.t("jobs.sort_by.location.ascending"))
  end
