class FilteredMailPayload
  ...
  def filtered_payload # rubocop:disable Metrics/AbcSize
    {}.tap do |h|
      ...
      # Serialise args to ensure ActiveRecord objects are converted to hashes before filtering otherwise filtering won't work.
