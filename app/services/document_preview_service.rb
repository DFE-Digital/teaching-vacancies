class DocumentPreviewService
  ...
  def blank_job_application_sample(vacancy)
    job_application = JobApplicationSample.build(
      ...
      training_and_cpds: 3,
      qualifications: { gcse: 5, a_level: 5, undergraduate: 2, postgraduate: 2 },
      professional_body_memberships: 2,
    )
    case vacancy.religion_type
    when :other_religtion
      job_application.assign_attributes(**JobApplicationSample.religious_attributes)
    when :catholic
      job_application.assign_attributes(**JobApplicationSample.catholic_attributes)
    end
  ...
  def religious_job_application_sample(vacancy)
    ...
    job_application.assign_attributes(
      **JobApplicationSample.religious_attributes,
  ...
  def catholic_job_application_sample(vacancy)
    job_application = JobApplicationSample.build(vacancy)
    job_application.assign_attributes(
      **JobApplicationSample.catholic_attributes,
