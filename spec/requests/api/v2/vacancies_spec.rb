               ...
               properties: {
                 data: {
                   ...
                   items: {
                     type: :object,
                     additionalProperties: false,
                     required: %i[advertUrl expiresAt jobTitle salaryRange schoolUrns jobRole workingPatterns contractType phase],
                     properties: {
                       ...
                       subjects: {
                         ...
                         items: {
                           type: :string,
                           enum: %i[accounting art_and_design biology business_studies chemistry citizenship classics
