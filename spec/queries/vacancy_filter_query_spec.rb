...
RSpec.describe VacancyFilterQuery do
  ...
  before(:all) do
    Vacancy.transaction do
      ...
      create(:vacancy, :apply_via_website, job_title: "Vacancy 14", phases: %w[primary], organisations: [non_faith_school1])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 15-NFV2", phases: %w[primary], organisations: [non_faith_school2])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 14-NFV3", phases: %w[primary], organisations: [non_faith_school3], visa_sponsorship_available: true)
      ...
      create(:vacancy, :apply_via_website, job_title: "Vacancy 7S", phases: %w[primary], organisations: [special_school1])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 8S", phases: %w[primary], organisations: [special_school2])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 9S", phases: %w[primary], organisations: [special_school3])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 10S", phases: %w[primary], organisations: [special_school4])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 11S", phases: %w[primary], organisations: [special_school5])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 12S", phases: %w[primary], organisations: [special_school6])

      academies = create(:academy, name: "Academy1")
      create(:vacancy, :apply_via_website, job_title: "Vacancy 5", phases: %w[primary], job_roles: ["head_of_year_or_phase"], organisations: [academies])
      ...
      create(:vacancy, :apply_via_website, job_title: "Vacancy 13F", phases: %w[primary], publisher_organisation: faith_school, organisations: [faith_school, faith_school2])
      ...
      create(:vacancy, :apply_via_website, job_title: "Vacancy 8FR", phases: %w[primary], job_roles: ["assistant_headteacher"], publisher_organisation: free_school, organisations: [free_school, free_schools])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 9FR", phases: %w[primary], job_roles: ["deputy_headteacher"], publisher_organisation: free_school, organisations: [free_school, free_schools])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 10FR", phases: %w[primary], job_roles: ["teaching_assistant"], publisher_organisation: free_school, organisations: [free_school, free_schools])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 11FR", phases: %w[primary], job_roles: ["higher_level_teaching_assistant"], publisher_organisation: free_school, organisations: [free_school, free_schools])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 12FR", phases: %w[primary], job_roles: ["education_support"], publisher_organisation: free_school, organisations: [free_school, free_schools])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 13FR", phases: %w[primary], job_roles: ["sendco"], publisher_organisation: free_school, organisations: [free_school, free_schools])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 15FR", phases: %w[primary], job_roles: ["administration_hr_data_and_finance"], publisher_organisation: free_school, organisations: [free_school, free_schools])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 16FR", phases: %w[primary], job_roles: ["it_support"], publisher_organisation: free_school, organisations: [free_school, free_schools])
      create(:vacancy, :apply_via_website, job_title: "Vacancy 17FR", phases: %w[primary], job_roles: ["pastoral_health_and_welfare"], publisher_organisation: free_school, organisations: [free_school, free_schools])
