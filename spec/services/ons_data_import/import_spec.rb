...
RSpec.describe OnsDataImport::Import, :vcr do
  ...
  it "raises an error" do
    expect {
      described_class.call(api_name: api_name, name_field: name_field,
                           valid_locations: %w[something], tolerance: OnsDataImport::Import::SIMPLIFICATION_TOLERANCE)
