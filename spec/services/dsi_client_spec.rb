...
RSpec.describe DSIClient do
  subject(:client) do
    # See AuthHelpers#stub_publisher_authorisation_step for UUIDs
    described_class.new(
  ...
  describe "#roles" do
    ...
    context "when the response is a 404" do
      before { stub_publisher_authorisation_step_with_not_found }
    ...
    context "when the external response status is 500" do
      before { stub_publisher_authorisation_step_with_external_error }
