...
RSpec.describe DeleteUnconfirmedSubscriptionsJob do
  describe "#perform" do
    ...
    it "discards subscriptions warned more than 1 month ago" do
    ...
    it "results in the correct subscription count" do
      # Total created: 4
      # Active remaining: 2 (recently_warned_subscription, unwarned_subscription have not been discarded)
      # Discarded: 2 (already_unsubscribed, not counted by default as already discarded and subscription_to_delete which has been discarded)
