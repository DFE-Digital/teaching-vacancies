    ...
    module Publisher
      module Ats
        class SatisfactoryReferencePage < CommonPage
          ...
          element :yes, "label[for='publishers-job-application-mark-as-received-form-reference-satisfactory-true-field']"
          element :no, "label[for='publishers-job-application-mark-as-received-form-reference-satisfactory-false-field']"
