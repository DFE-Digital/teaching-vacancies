    ...
    describe "#comment" do
      context "when comment is blank" do
        ...
        it "requests an entry in the field" do
          ...
          expect(subject.errors.messages[:comment]).to include(I18n.t("job_alert_feedback_errors.comment.blank"))
        end
      end
      ...
      context "when comment is too long" do
        ...
        it "returns the correct error" do
          expect(subject).not_to be_valid
          expect(subject.errors.messages[:comment]).to include(I18n.t("job_alert_feedback_errors.comment.too_long"))
        end
      end
    end
  end
