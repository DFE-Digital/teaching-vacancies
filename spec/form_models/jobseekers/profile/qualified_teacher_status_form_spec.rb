...
RSpec.describe Jobseekers::Profile::QualifiedTeacherStatusForm, type: :model do
  ...
  describe "validations" do
    context "when qualified_teacher_status is 'yes'" do
      let(:attributes) { { qualified_teacher_status: "yes", qualified_teacher_status_year: current_year, teacher_reference_number: "1234567", has_teacher_reference_number: "yes", statutory_induction_complete: "yes" } }
