  ...
  describe "#validations" do
    context "when keywords is blank" do
      ...
      it "validates presence of keywords" do
        ...
        expect(subject.errors.messages[:keywords]).to include(I18n.t("nqt_job_alert_errors.keywords.blank"))
      end
    end
    ...
    describe "#email" do
      context "when email is blank" do
        ...
        it "validates presence of email" do
          expect(subject.valid?).to be(false)
          expect(subject.errors.messages[:email]).to include(I18n.t("nqt_job_alert_errors.email.blank"))
        end
      end
      ...
      context "when email is invalid" do
        ...
        it "validates validity of email" do
          expect(subject.valid?).to be(false)
          expect(subject.errors.messages[:email]).to include(I18n.t("nqt_job_alert_errors.email.invalid"))
        end
      end
    end
