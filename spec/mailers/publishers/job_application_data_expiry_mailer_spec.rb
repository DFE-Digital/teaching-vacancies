...
RSpec.describe Publishers::JobApplicationDataExpiryMailer do
  ...
  describe "#job_application_data_expiry" do
    it "sends a `job_application_data_expiry` email" do
      expect(mail.subject).to eq(I18n.t("publishers.job_application_data_expiry_mailer.job_application_data_expiry.subject", job_title: vacancy.job_title, published_date: vacancy.publish_on.to_fs(:day_month_year)))
