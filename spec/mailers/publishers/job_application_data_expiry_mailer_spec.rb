    ...
    it "sends a `job_application_data_expiry` email" do
      ...
      expect(mail.personalisation)
        .to include(job_title: vacancy.job_title, expiration_date: vacancy_data_expiration_date,
                    ...
                    privacy_policy_link: "https://www.gov.uk/government/publications/privacy-information-education-providers-workforce-including-teachers/privacy-information-education-providers-workforce-including-teachers",
