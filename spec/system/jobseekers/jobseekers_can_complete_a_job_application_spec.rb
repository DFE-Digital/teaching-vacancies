...
RSpec.describe "Jobseekers can complete a job application" do
  ...
  context "with a catholic vacancy" do
    ...
    it "allows jobseekers to complete an application and go to review page", :js do
      visit jobseekers_job_application_build_path(job_application, :personal_details)
      expect(page).to have_content(I18n.t("jobseekers.job_applications.build.personal_details.heading"))
      expect(page).to have_field("Email address", with: jobseeker.email)
      validates_step_complete
      ...
      expect(page).to have_content(I18n.t("jobseekers.job_applications.build.religion_details.faith.hint"))
      validates_step_complete
      ...
      fill_in "What is your religious denomination or faith?", with: "Catholic"
      choose I18n.t("helpers.legend.jobseekers_job_application_religion_details_form.religious_reference_type_options.no_referee")
      click_on I18n.t("buttons.save_and_continue")
      # validates_step_complete
      sleep 20
      ...
      # sleep 20
      #
      # choose I18n.t("helpers.legend.jobseekers_job_application_religion_details_form.religious_reference_type_options.baptism_certificate")
      # validates_step_complete
      # sleep 20
      #
      # choose I18n.t("helpers.legend.jobseekers_job_application_religion_details_form.religious_reference_type_options.baptism_date")
      # validates_step_complete
      # sleep 20
      #
      # click_on I18n.t("buttons.save_and_continue")
