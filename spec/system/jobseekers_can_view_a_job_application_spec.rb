...
RSpec.describe "Jobseekers can view a job application" do
  ...
  it "displays all the job application information" do
    show_page.steps(text: I18n.t("jobseekers.job_applications.build.personal_details.title")).first.within do |personal_details|
    ...
    show_page.steps(text: I18n.t("jobseekers.job_applications.build.professional_status.title")).first.within do |professional_status|
    ...
    job_application.employment_history.order(:created_at).each_with_index do |employment_history_details, index|
      show_page.steps(text: I18n.t("jobseekers.job_applications.build.employment_history.title")).first.within do |employment_history|
    ...
    show_page.steps(text: I18n.t("jobseekers.job_applications.build.personal_statement.title")).first.within do |personal_statement|
    ...
    job_application.references.order(:created_at).each_with_index do |reference_details, index|
      show_page.steps(text: I18n.t("jobseekers.job_applications.build.references.title")).first.within do |reference|
    ...
    show_page.steps(text: I18n.t("jobseekers.job_applications.build.equal_opportunities.title")).first.within do |equal_opportunities|
    ...
    show_page.steps(text: I18n.t("jobseekers.job_applications.build.ask_for_support.title")).first.within do |ask_for_support|
    ...
    show_page.steps(text: I18n.t("jobseekers.job_applications.build.declarations.title")).first.within do |declarations|
