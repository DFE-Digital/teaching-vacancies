...
RSpec.describe "Application feature reminder" do
  ...
  context "when job listing exists that does not allow job applications" do
    let!(:vacancy) { create(:vacancy, :published, enable_job_applications: false, created_at: 1.days.ago, publisher: publisher, organisations: [organisation]) }
