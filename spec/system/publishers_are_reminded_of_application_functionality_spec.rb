...
RSpec.describe "Application feature reminder" do
  ...
  context "when publisher has seen the new features page" do
    ...
    context "there are published vacancies since that accept applications through teacher vacancies" do
    ...
    context "there are no published vacancies since that accept applications through teacher vacancies" do
