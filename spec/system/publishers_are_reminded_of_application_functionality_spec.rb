...
RSpec.describe "Application feature reminder" do
  ...
  context "when publisher has seen the new features page" do
    ...
    context "there are vacancies published since that accept applications through teacher vacancies" do
    ...
    context "there are vacancies published since that do not accept applications through teacher vacancies" do
