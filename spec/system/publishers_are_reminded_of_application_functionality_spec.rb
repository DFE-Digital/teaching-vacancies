...
RSpec.describe "Application feature reminder" do
  ...
  context "when publisher has seen the New features page" do
    ...
    context "published vacancies since that accept applications through teacher vacancies" do
    ...
    context "no published vacancies since that accept applications through teacher vacancies" do
