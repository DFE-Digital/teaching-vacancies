...
RSpec.describe "Creating a vacancy" do
  ...
  let(:vacancy) { build(:vacancy, :no_tv_applications, :ect_suitable, job_roles: ["teacher"], phases: %w[secondary],
  ...
  let(:ignored_fields) {
    [:searchable_content, :id, :updated_at, :created_at, :geolocation, :slug, :completed_steps, :publisher_id, :publisher_organisation_id]
  }
  ...
  scenario "publishes a vacancy" do
    ...
    fill_in_key_stages_form_fields(vacancy.key_stages)
    ...
    fill_in_contract_information_form_fields(contract_type: vacancy.contract_type, contract_length: vacancy.fixed_term_contract_duration)
    click_on I18n.t("buttons.save_and_continue")
