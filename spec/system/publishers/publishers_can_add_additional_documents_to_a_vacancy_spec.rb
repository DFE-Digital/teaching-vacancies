...
RSpec.describe "Publishers can add additional documents to a vacancy" do
  ...
  let(:primary_school) { create_default(:school, name: "Primary school", phase: "primary") }
  ...
  it "passes a11y", :a11y, :retry do
    # wait for page load
    expect(page).to have_content I18n.t("buttons.save_and_continue")
  ...
  scenario "can add an additional documents to a vacancy" do
    ...
    unsafe_doc.blob.malware_scan_malicious!
