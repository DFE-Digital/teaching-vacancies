...
Rails.application.routes.draw do
  ...
  match "teaching-jobs-in-:location_facet",
        ...
        constraints: ->(request) { LocationPolygon.include?(request.params[:location_facet].tr("-", "_")) }
  ...
  match "teaching-jobs-for-:subject",
        ...
        constraints: ->(request) { SUBJECT_OPTIONS.map(&:first).include?(request.params[:subject].tr("-", "_")) },
