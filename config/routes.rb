Rails.application.routes.draw do
  ...
  if AuthenticationFallback.enabled?
    get 'auth/email/sessions/new', to: 'hiring_staff/sign_in/email/sessions#new', as: 'new_auth_email'
    post 'auth/email/sessions/check-your-email', to: 'hiring_staff/sign_in/email/sessions#check_your_email', as: 'auth_email_check_your_email'
    get 'auth/email/sessions/choose-organisation', to: 'hiring_staff/sign_in/email/sessions#choose_organisation', as: 'auth_email_choose_organisation'
    get 'auth/email/sessions/sign-in', to: 'hiring_staff/sign_in/email/sessions#create', as: 'auth_email_sign_in'
    get 'auth/email/sessions/sign-out', to: 'hiring_staff/sign_in/email/sessions#destroy', as: 'auth_email_sign_out'
    get 'auth/email/sessions/change-organisation', to: 'hiring_staff/sign_in/email/sessions#change_organisation', as: 'auth_email_change_organisation'
  else
  # DfE Sign In
    resource :sessions,
            only: %i[create new],
  ...
  resource :school, only: %i[show edit update], controller: 'hiring_staff/schools' do
    ...
    resources :jobs, only: %i[new edit destroy delete show], controller: 'hiring_staff/vacancies' do
      get 'review',
        defaults: { create_step: 7, step_title: I18n.t('jobs.review_heading') }
      get 'preview'
      get 'summary'
      ...
      resource :important_dates,
        ...
        defaults: { create_step: 3, step_title: I18n.t('jobs.important_dates') }
      resource :supporting_documents,
        only: %i[show update],
        controller: 'hiring_staff/vacancies/supporting_documents',
        defaults: { create_step: 4, step_title: I18n.t('jobs.supporting_documents') }
      resource :documents,
      ...
      resource :application_details,
        ...
        defaults: { create_step: 5, step_title: I18n.t('jobs.application_details') }
      resource :job_summary,
        only: %i[show update],
        controller: 'hiring_staff/vacancies/job_summary',
        defaults: { create_step: 6, step_title: I18n.t('jobs.job_summary') }
