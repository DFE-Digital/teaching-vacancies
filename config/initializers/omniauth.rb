...
# FIXME: Remove these once the DSI role changes are done
ENV["DFE_SIGN_IN_SERVICE_ACCESS_ROLE_ID"] ||= ENV["DFE_SIGN_IN_PUBLISHER_ROLE_ID"]
ENV["DFE_SIGN_IN_PUBLISHER_ROLE_ID"] ||= ENV["DFE_SIGN_IN_SERVICE_ACCESS_ROLE_ID"]
