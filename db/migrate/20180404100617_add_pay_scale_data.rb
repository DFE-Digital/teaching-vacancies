class AddPayScaleData < ActiveRecord::Migration[5.1]
  def change
    PAYSCALE_DATA.each do |scale|
      payscale = PayScale.find_or_initialize_by(code: scale[0])
      payscale.label = scale[1]
      payscale.salary = scale[2]
      payscale.expires_at = Date.new(2018, 8, 31)
      payscale.save
    end
  end

  PAYSCALE_DATA = [['MPS1', 'Minimum Pay Range 1', 22917],
                   ...
                   ['LPS43', 'Lead Practitioners Range 43', 109366]].freeze
end
