...
UPDATE jobseekers
    -- Avoid setting confirmation token, unlock token, and reset password token, because it causes the error
    -- "duplicate key value violates unique constraint", which prevents all updates to jobseekers.
