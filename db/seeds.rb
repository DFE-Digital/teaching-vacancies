...
# Change default organisation for publishers
# TODO: Undo all changes in this file!!
org = SchoolGroup.find_by!(uid: "5143")
...
users.each do |user|
  Publisher.create(organisations: [org], **user)
  SupportUser.create(user)
end
# Publishers
attrs = { organisations: [org] }
