...
3000.times { FactoryBot.create(:vacancy, :for_seed_data, **attrs) }
...
200.times { |i| FactoryBot.create(:weekly_subscription, :with_some_criteria, keyword: nil, email: stephen.email, radius: i, location: postcodes.sample) }
