...
terraform-app-database-replace: terraform-app-init check-docker-tag
	...
	cd terraform/app && terraform apply -replace="module.paas.cloudfoundry_service_instance.postgres_instance" -replace="module.paas.cloudfoundry_app.web_app" -replace="module.paas.cloudfoundry_app.worker_app" -var-file ../workspace-variables/${var_file}.tfvars -auto-approve
