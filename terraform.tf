...
module "ecs" {
  ...
  ecs_service_name                      = "${var.project_name}_${var.ecs_service_name}_${terraform.workspace}"
  ecs_service_task_name                 = "${var.project_name}_${var.ecs_service_task_name}_${terraform.workspace}"
