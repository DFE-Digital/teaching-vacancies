SELECT
  *,
  ...
  1.96*SAFE.SQRT(SAFE_DIVIDE(exclusivity_rate_this_month*(1-exclusivity_rate_this_month),
      sample_size_this_month)*SAFE_DIVIDE(vacancies_published_this_month-sample_size_this_month,
      vacancies_published_this_month - 1)) AS exclusivity_rate_confidence_interval,
  1.96*SAFE.SQRT(SAFE_DIVIDE(exclusivity_rate_this_AY_so_far*(1-exclusivity_rate_this_AY_so_far),
      sample_size_this_AY_so_far)*SAFE_DIVIDE(vacancies_published_this_AY_so_far-sample_size_this_AY_so_far,
      vacancies_published_this_AY_so_far - 1)) AS exclusivity_rate_confidence_interval_this_AY_so_far,
  1.96*SAFE.SQRT(SAFE_DIVIDE(exclusivity_rate_in_the_last_year*(1-exclusivity_rate_in_the_last_year),
      sample_size_in_the_last_year)*SAFE_DIVIDE(vacancies_published_in_the_last_year-sample_size_in_the_last_year,
      vacancies_published_in_the_last_year - 1)) AS exclusivity_rate_confidence_interval_in_the_last_year,
  1.96*SAFE.SQRT(SAFE_DIVIDE(exclusive_hires_rate_this_month*(1-exclusive_hires_rate_this_month),
      sample_size_this_month)*SAFE_DIVIDE(vacancies_published_this_month-sample_size_this_month,
      vacancies_published_this_month - 1)) AS exclusive_hires_rate_confidence_interval,
  1.96*SAFE.SQRT(SAFE_DIVIDE(exclusive_hires_rate_this_AY_so_far*(1-exclusive_hires_rate_this_AY_so_far),
      sample_size_this_AY_so_far)*SAFE_DIVIDE(vacancies_published_this_AY_so_far-sample_size_this_AY_so_far,
      vacancies_published_this_AY_so_far - 1)) AS exclusive_hires_rate_confidence_interval_this_AY_so_far,
  1.96*SAFE.SQRT(SAFE_DIVIDE(exclusive_hires_rate_in_the_last_year*(1-exclusive_hires_rate_in_the_last_year),
      sample_size_in_the_last_year)*SAFE_DIVIDE(vacancies_published_in_the_last_year-sample_size_in_the_last_year,
      vacancies_published_in_the_last_year - 1)) AS exclusive_hires_rate_confidence_interval_in_the_last_year,
  1.96*SAFE.SQRT(SAFE_DIVIDE(hires_rate_through_TV_this_month*(1-hires_rate_through_TV_this_month),
      sample_size_this_month)*SAFE_DIVIDE(vacancies_published_this_month-sample_size_this_month,
      vacancies_published_this_month - 1)) AS hires_rate_through_TV_confidence_interval,
  1.96*SAFE.SQRT(SAFE_DIVIDE(hires_rate_through_TV_this_AY_so_far*(1-hires_rate_through_TV_this_AY_so_far),
      sample_size_this_AY_so_far)*SAFE_DIVIDE(vacancies_published_this_AY_so_far-sample_size_this_AY_so_far,
      vacancies_published_this_AY_so_far - 1)) AS hires_rate_through_TV_confidence_interval_this_AY_so_far,
  1.96*SAFE.SQRT(SAFE_DIVIDE(hires_rate_through_TV_in_the_last_year*(1-hires_rate_through_TV_in_the_last_year),
      sample_size_in_the_last_year)*SAFE_DIVIDE(vacancies_published_in_the_last_year-sample_size_in_the_last_year,
      vacancies_published_in_the_last_year - 1)) AS hires_rate_through_TV_confidence_interval_in_the_last_year,
  SAFE_DIVIDE(1.96*SAFE.SQRT(SAFE_DIVIDE(in_scope_exclusive_hires_rate_this_AY_so_far*(1-in_scope_exclusive_hires_rate_this_AY_so_far),
        in_scope_sample_size_this_AY_so_far)*SAFE_DIVIDE(in_scope_vacancies_published_this_AY_so_far-in_scope_sample_size_this_AY_so_far,
        in_scope_sample_size_this_AY_so_far-1)),
  ...
  SAFE_DIVIDE(1.96*SAFE.SQRT(SAFE_DIVIDE(in_scope_exclusive_hires_rate_in_the_last_year*(1-in_scope_exclusive_hires_rate_in_the_last_year),
        in_scope_sample_size_in_the_last_year)*SAFE_DIVIDE(in_scope_vacancies_published_in_the_last_year-in_scope_sample_size_in_the_last_year,
        in_scope_sample_size_in_the_last_year-1)),
...
FROM (
  SELECT
    *,
    ...
    SUM(in_scope_vacancies_published_this_month) OVER (PARTITION BY AY_beginning ORDER BY month ASC ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) AS in_scope_vacancies_published_this_AY_so_far,
    ...
    1200*in_scope_exclusive_hires_this_month*1.96*SAFE_DIVIDE(SAFE.SQRT(SAFE_DIVIDE(in_scope_exclusive_hires_rate_this_month*(1-in_scope_exclusive_hires_rate_this_month),
          in_scope_sample_size_this_month)*SAFE_DIVIDE(in_scope_vacancies_published_this_month-in_scope_sample_size_this_month,
          in_scope_sample_size_this_month-1)),
